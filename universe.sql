...
INSERT INTO public.galaxy VALUES (1, 'Milky Way', 999.9, 0.00, 'The galaxy containing our solar system.', NULL);
INSERT INTO public.galaxy VALUES (2, 'Andromeda', 999.9, 253.70, 'The nearest major galaxy to the Milky Way.', NULL);
INSERT INTO public.galaxy VALUES (3, 'Triangulum', 880.0, 300.00, 'The third-largest galaxy in the Local Group.', NULL);
INSERT INTO public.galaxy VALUES (4, 'Whirlpool', 400.0, 230.00, 'Famous for its spiral structure.', NULL);
INSERT INTO public.galaxy VALUES (5, 'Sombrero', 999.9, 290.00, 'Notable for its bright nucleus and large central bulge.', NULL);
INSERT INTO public.galaxy VALUES (6, 'Black Eye', 640.0, 170.00, 'A galaxy with a dark band of absorbing dust.', NULL);
...
INSERT INTO public.planet VALUES (1, 'Earth', true, true, 'The only known planet with life.', 4540.0, 0.00, 1, NULL);
INSERT INTO public.planet VALUES (2, 'Mars', false, true, 'Known as the Red Planet.', 4500.0, 0.52, 1, NULL);
INSERT INTO public.planet VALUES (3, 'Venus', false, true, 'The second planet from the Sun.', 4500.0, 0.28, 1, NULL);
INSERT INTO public.planet VALUES (4, 'Jupiter', false, true, 'The largest planet in the Solar System.', 4500.0, 4.20, 1, NULL);
INSERT INTO public.planet VALUES (5, 'Saturn', false, true, 'Famous for its prominent ring system.', 4500.0, 8.50, 1, NULL);
INSERT INTO public.planet VALUES (6, 'Uranus', false, true, 'The seventh planet from the Sun.', 4500.0, 18.20, 1, NULL);
INSERT INTO public.planet VALUES (7, 'Neptune', false, true, 'The farthest known planet from the Sun.', 4500.0, 29.10, 1, NULL);
INSERT INTO public.planet VALUES (8, 'Proxima b', false, true, 'An exoplanet in the habitable zone of Proxima Centauri.', 4300.0, 4.24, 3, NULL);
INSERT INTO public.planet VALUES (9, 'Kepler-22b', false, true, 'A potential candidate for habitability.', 2200.0, 620.00, 4, NULL);
INSERT INTO public.planet VALUES (10, 'Gliese 581g', false, true, 'An exoplanet that may have conditions for life.', 3000.0, 20.30, 3, NULL);
INSERT INTO public.planet VALUES (11, 'HD 209458b', false, true, 'An exoplanet known as a "hot Jupiter."', 2000.0, 150.40, 4, NULL);
INSERT INTO public.planet VALUES (12, 'Tau Ceti f', false, true, 'An exoplanet in the Tau Ceti system.', 5000.0, 11.90, 5, NULL);
...
INSERT INTO public.planet_types VALUES (2, 'Gas Giant', NULL, NULL);
INSERT INTO public.planet_types VALUES (3, 'Ice Giant', NULL, NULL);
INSERT INTO public.planet_types VALUES (4, 'Dwarf Planet', NULL, NULL);
